                    ...
                    <div id="wowslider-container1">
                        <div class="ws_images">
                            <ul>
                                ...
                                <li>
                                    <a href="actualiteb7b5.html?W9mvyDvFWE5=3506">
                                        <img src="BlocLiberal/image/images/reunion1.jpg" alt="" title="Ensemble nous irons loin" id="wows1_0" />
                                    </a>
                                </li>
                            </ul>
                        </div>
                        <div class="ws_bullets">
                            <div>
                                <a href="#" title="Reunion des membres du bl"><span>1</span></a>
                                <a href="#" title="Unis pour un meme objectif"><span>2</span></a>
                                <a href="#" title="COMMUNIQUÉ DU BL "><span>3</span></a>
                ...
                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                    <a href="contributions.html">
                        <div id="faire_don">
                            ...
                            <div>Adhérez <span>et/ou</span> Faites un don !</div>
                        </div>
                    </a>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-4 col-md-4 col-sm-4 wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="900ms">
                    ...
                    <div class="fb-page" data-href="https://www.facebook.com/FRONTPOPULAIREIVOIRIEN/" data-small-header="false" data-adapt-container-width="true" data-hide-cover="false" data-show-facepile="true" data-show-posts="false"></div>
                </div>
            </div>
            <div class="row" style="font-size:12px; margin-top:10px;">
                <div class="col-lg-10 col-md-10 col-sm-10">
                    <a href="https://fpi-ci.com:443/celestadmin/" target="_blank" style="color:#fff; text-decoration:none;">&copy;</a> Le Bloc Libéral, Tous Droits R&eacute;serv&eacute;s.
                </div>
